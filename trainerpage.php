<?php
	...
	require ('function/authTrainerPage.php');
?>
<!DOCTYPE html>
<html>
<head>
	...
	<title>FPT Training || Trainer page</title>
...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
		<div class="container">
			<a class="navbar-brand" href="#">FPT Training - Trainer page</a>
		  ...
		  <div class="collapse navbar-collapse" id="navbarSupportedContent">
		    <ul class="navbar-nav ml-auto">
		      	...
		      	<?php
		      		$buttonQuery = "SELECT * FROM administrator WHERE administratorID = '".$_SESSION['userID']."'";
		      		$buttonResult = mysqli_query($connection, $buttonQuery) or die(mysqli_error($connection));
		      		if (mysqli_num_rows($buttonResult) != 0)
		      		{
		      			?>
							<li class="nav-item">
								<a href="administratorpage.php?choose=trainee" class="nav-link">Back to admin page</a>
							</li>
		      			<?php
		      		}
		      	?>
		      	...
		      	<li class="nav-item">
					<a href="#" class="nav-link"><?=$_SESSION["userID"];?></a>		      		
		      	</li>
		    	<li>
							...
							else
							{
								...
								{?>
									<tr>
										...
										<td align = "center">
											<a href = "function/trainerAssign.php?courseID=<?=$row['courseID']; ?>">
												Choose
											</a>
										</td>
									</tr>
